   ...
   <!-- Page level plugins -->
   <script src="{{ url('bt') }}/vendor/chart.js/Chart.min.js"></script>

   <!-- Page level custom scripts -->
   <script src="{{ url('bt') }}/js/demo/chart-area-demo.js"></script>
   <script src="{{ url('bt') }}/js/demo/chart-pie-demo.js"></script>
